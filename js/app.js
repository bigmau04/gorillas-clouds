...
const PRODUCTS = [
  ...
  {
    id: 5,
    name: "Cápsula Green Dragon Live Resin 1G",
    category: "cartuchos",
    price: 50000,
    formattedPrice: "$50.000 COP",
    strains: "Híbrida - Green Dragon Strain",
    cannabinoids: ["Cápsula 510", "Live Resin 100%", "Terpenos Botánicos"],
    desc: "Cápsula 510 de resina viva concentrada. Perfil terpénico aromático natural con efecto relajante muscular de larga duración.",
    image: "img/destilado-5.jpg",
    badge: "Cápsula 510 🌿"
  },
  {
    id: 6,
    name: "Cápsula Tangie Live Resin 1G",
    category: "cartuchos",
    price: 50000,
    formattedPrice: "$50.000 COP",
    strains: "Sativa Energizante - Tangie Citrus 1G",
    cannabinoids: ["Live Resin 1G", "Cápsula 510", "Terpenos Cítricos"],
    desc: "Cápsula 510 de 1 gramo con resina viva sabor cítrico dulce Tangie. Enfoque diurno activo y elevación lúcida.",
